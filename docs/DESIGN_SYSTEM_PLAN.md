# Доработка дизайн-системы Nemo

> **Статус:** историческая базовая спецификация; степень реализации требует
> повторной сверки с текущими CSS tokens и компонентами. Не использовать как
> готовый checklist без обновления.
