...
2.  **React 19.2 Standards**:
    *   Всегда используй актуальные типы и методы React 19.2 (например, `ref` как проп вместо `forwardRef`).
...
5.  **Clean Code & Feature-Driven Architecture (FDA)**:
