...
> **Текущий блокер:** `scripts/distill_prod.sh` остаётся небезопасным прототипом.
> Публичный push запрещён до реализации gates из
> `docs/ARCHITECTURE_AUDIT.md` и этого плана.
