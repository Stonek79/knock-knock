...
> ⚠️ Таблица окружений в этом документе устарела. Используйте URL из локального
> `.env` и текущую схему из `CURRENT_STATE.md`; домены и контейнеры ниже могут
> быть историческими примерами.
